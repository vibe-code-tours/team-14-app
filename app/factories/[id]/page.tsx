  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-grow max-w-4xl mx-auto p-4 md:p-8 mt-6 w-full space-y-8 animate-fade-in">
        {/* Factory Hero & Info Card */}
        <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100 grid md:grid-cols-2 gap-8 relative overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-4xl font-extrabold text-slate-800 flex items-center gap-1">
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <div className="bg-emerald-50 border border-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-0.5">
                        ⭐ {overallRating}
                      </div>
                    </div>

    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
        ...
        <div className="flex-1 sm:flex-none">
          <label className="block text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1 sm:hidden">
            {t("filters.region")}
          </label>
        ...
        {hasFilters && (
          <button
            onClick={onClear}
            className="text-xs text-slate-400 hover:text-slate-600 underline transition sm:ml-2"
          >
            {t("filters.clear")}
          </button>
        )}

...
export function Navbar() {
  ...
  return (
    <>
      <nav className="bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-slate-800 dark:to-slate-900 text-white h-16 px-4 sm:px-6 sticky top-0 z-20 shadow-md dark:shadow-slate-900/50">
        <div className="max-w-5xl mx-auto h-full flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-3 md:gap-4 text-sm">
            ...
            <Link
              href="/factories"
              className="hover:text-emerald-200 transition py-1"
            >
              {t("nav.factories")}
            </Link>
            <Link
        ...
        {/* Mobile dropdown */}
        {menuOpen && (
          <div className="md:hidden mt-3 pb-1 space-y-1 border-t border-white/20 pt-3 bg-emerald-700 dark:bg-slate-800 rounded-b-xl animate-fade-in">
            <Link
              href="/"

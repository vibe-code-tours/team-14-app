...
export const translations: Record<string, TranslationEntry> = {
  ...
  "factoryForm.type": { en: "Industry Type", my: "စက်မှု အမျိုးအစား" },
  "factoryForm.typePlaceholder": { en: "e.g. 1 (Manufacturing)", my: "ဥပမာ။ 1 (ထုတ်လုပ်ရေး)" },
  "factoryForm.country": { en: "Country", my: "နိုင်ငံ" },
  "factoryForm.countryPlaceholder": { en: "e.g. Thailand", my: "ဥပမာ။ ထိုင်း" },
  ...
  "factoryDetail.type": { en: "Industry Type", my: "စက်မှု အမျိုးအစား" },
